...
/*	 更新
/*/
void AnimChara::Update( )
{
	printf( "AnimChara : Action = %d\n" , Pmode_ ) ;
	...
	// デバッグ用
	printf( "AnimChara : left   = %d \n" , nowAnim->cutRect.left ) ;
	printf( "AnimChara : top    = %d \n" , nowAnim->cutRect.top ) ;
	printf( "AnimChara : right  = %d \n" , nowAnim->cutRect.right ) ;
	printf( "AnimChara : bottom = %d \n" , nowAnim->cutRect.bottom ) ;
	printf( "AnimChara : Xpos   = %8.4f \n" , Player_xpos_ ) ;
	printf( "AnimChara : Ypos   = %8.4f \n" , Player_ypos_ ) ;
	printf( "AnimChara : Xspd   = %8.4f \n" , Player_spd_.x ) ;
	printf( "AnimChara : Yspd   = %8.4f \n" , Player_spd_.y ) ;
	printf( "AnimChara : Xmag   = %8.4f \n" , Player_mag_.x ) ;
	printf( "AnimChara : Ymag   = %8.4f \n" , Player_mag_.y ) ;
	printf( "AnimChara : mag    = %8.4f \n" , Player_vec_.mag ) ;
	printf( "AnimChara : deg    = %8.4f \n" , Player_vec_.deg ) ;
